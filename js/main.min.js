...
if (isMobile.any()) {
  $('[spollerbtn]').click(function () {

    if ($(window).width() < 768){
      $(this).toggleClass('_init');
      $(this).next('[spoller]').slideToggle(300);
    }
  });
}
...
$(document).ready(function(){
  $('.icon-menu').click(function(event){
      $('.icon-menu,.menu_body').toggleClass('_active');
  });
});
...
$(function(){
 $('.products__slider').slick({
  prevArrow: ' <button class="slider-btn slider-btn__left"><svg width="10" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.218 1L1 9l8.218 8" stroke="#000"/></svg></button>',
  nextArrow:' <button class="slider-btn slider-btn__right"><svg width="10" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.782 17L9 9 .782 1" stroke="#000"/></svg></button>',
  infinite: false,
  paralax: true,
...
$('.questions__item-title').on('click', function(){
  // $('.questions__text').css( "display", "none" )
  if(!$(this).parent().children().last().hasClass('_active_text')){
  const act = document.querySelector('._active_text')
  console.log(act);
  $(act).slideToggle(300)
  $(act).removeClass('_active_text')
  $(act).parent().removeClass('_active_arrow')
    


  // $('.questions__item').removeClass('questions__item--acive')
  $(this).parent().children().last().addClass('_active_text')
  $(this).parent().addClass('_active_arrow')
  $(this).parent().children().last().slideToggle(300)
  }
...
$('#fullpage').fullpage({
  ...
  scrollOverflow: true,
  anchors: ['top', 'page-section', 'benefits', 'specification', 'questions', 'contacts'],
	menu: '#header-nav',
